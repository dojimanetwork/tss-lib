...
func newRound1(params *tss.Parameters, key *keygen.LocalPartySaveData, data *ECSignatureData, temp *localTempData, out chan<- tss.Message, end chan<- *ECSignatureData) tss.Round {
	return &round1{
