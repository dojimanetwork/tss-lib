...
func newRound1(params *tss.Parameters, key *keygen.LocalPartySaveData, data *EDSignatureData, temp *localTempData, out chan<- tss.Message, end chan<- *EDSignatureData) tss.Round {
	return &round1{
