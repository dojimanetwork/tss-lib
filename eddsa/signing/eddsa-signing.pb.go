...
var file_protob_eddsa_signing_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x35, 0x0a, 0x13, 0x45, 0x44, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x7e, 0x0a, 0x13, 0x45, 0x44, 0x53, 0x69,
	0x67, 0x6e, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x32, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x52, 0x06, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x54, 0x22, 0x23, 0x0a, 0x13, 0x45, 0x44, 0x53, 0x69,
	0x67, 0x6e, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x33, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	0x0c, 0x0a, 0x01, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x01, 0x73, 0x42, 0x30, 0x5a,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x6f, 0x6a, 0x69,
	0x6d, 0x61, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x74, 0x73, 0x73, 0x2d, 0x6c, 0x69,
	0x62, 0x2f, 0x65, 0x64, 0x64, 0x73, 0x61, 0x2f, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x62,
...
var file_protob_eddsa_signing_proto_goTypes = []interface{}{
	(*EDSignRound1Message)(nil), // 0: EDSignRound1Message
	(*EDSignRound2Message)(nil), // 1: EDSignRound2Message
	(*EDSignRound3Message)(nil), // 2: EDSignRound3Message
	(*common.ECPoint)(nil),      // 3: ECPoint
}
var file_protob_eddsa_signing_proto_depIdxs = []int32{
	3, // 0: EDSignRound2Message.proof_alpha:type_name -> ECPoint
...
func file_protob_eddsa_signing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protob_eddsa_signing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EDSignRound1Message); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protob_eddsa_signing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EDSignRound2Message); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protob_eddsa_signing_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EDSignRound3Message); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
